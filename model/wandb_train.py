...
class Dataloader(pl.LightningDataModule):
    def __init__(self, model_name, batch_size, shuffle, train_path, dev_path, test_path, predict_path):
        ...
        self.tokenizer = transformers.AutoTokenizer.from_pretrained(model_name, max_length=170)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', default='./train_smoothing.csv')
    ...
    def sweep_train(config=None):
            ...
            wandb_logger = WandbLogger(
                    log_model="all",
                    name=f'{model_name_ch}_{config.batch_size}_{config.lr}',
            ...
            f'{model_name_ch}_{config.batch_size}_{config.lr}_model.pt')
